    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex gap-4">
          <button className="flex items-center gap-2 px-6 py-3 rounded-2xl border border-secondary/10 text-primary font-bold uppercase tracking-widest text-xs hover:bg-sand/30 transition-all">
            <Upload size={18} /> Batch Upload
          </button>
          <button className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-primary text-white font-bold uppercase tracking-widest text-xs hover:bg-secondary transition-all shadow-lg">
        ...
        {mockMusic.map((track, i) => (
          ...
          >
            <div className="flex justify-between items-start mb-6">
              ...
              <button className="p-2 text-earth/20 hover:text-primary transition-colors">
            ...
            <div className="flex items-center gap-4">
              <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-sand/50 text-primary font-bold text-xs uppercase tracking-widest hover:bg-accent transition-all">
                <Play size={14} fill="currentColor" /> Preview
              </button>
              <button className="p-3 rounded-xl border border-secondary/10 text-earth/30 hover:text-primary transition-all">
                <Edit2 size={18} />
              </button>
              <button className="p-3 rounded-xl border border-secondary/10 text-earth/30 hover:text-red-500 transition-all">
                <Trash2 size={18} />
              </button>
            </div>
          </motion.div>
