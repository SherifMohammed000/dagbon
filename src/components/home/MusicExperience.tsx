              ...
              <div className="bg-black/40 backdrop-blur-3xl p-8 md:p-12 rounded-[48px] border border-white/10 relative shadow-2xl overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row gap-12 items-center relative z-10">
                  ...
                  <div className="flex-1 w-full text-center md:text-left">
                    ...
                    <h3 className="text-3xl md:text-5xl font-serif mb-2 leading-tight">{active?.title}</h3>
                    <p className="text-xl text-sand/70 mb-10 font-light">{active?.artist}</p>
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-6 md:gap-10">
                      <button onClick={prevTrack} className="text-white/40 hover:text-white transition-all hover:scale-110">
                        <SkipBack size={32} />
                      </button>
                      <button
                        onClick={togglePlay}
                      ...
                      <button onClick={nextTrack} className="text-white/40 hover:text-white transition-all hover:scale-110">
                        <SkipForward size={32} />
                      </button>
